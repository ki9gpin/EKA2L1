...
namespace eka2l1::arm::r12l1 {
    ...
    bool arm_translate_visitor::arm_ADC_rsr(common::cc_flags cond, bool S, reg_index n, reg_index d, reg_index s,
        common::armgen::shift_type shift, reg_index m) {
        if (!condition_passed(cond)) {
            return false;
        }
    ...
    bool arm_translate_visitor::arm_RSB_rsr(common::cc_flags cond, bool S, reg_index n, reg_index d, reg_index s,
        common::armgen::shift_type shift, reg_index m) {
        if (!condition_passed(cond)) {
            return false;
        }
    ...
    bool thumb_translate_visitor::thumb16_SBC_reg(reg_index m, reg_index d_n) {
        common::armgen::arm_reg dest_and_op1_real = reg_index_to_gpr(d_n);
        common::armgen::arm_reg op2_real = reg_index_to_gpr(m);
