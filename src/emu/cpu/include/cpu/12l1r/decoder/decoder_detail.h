...
namespace eka2l1::arm::r12l1::decoder {
    ...
    private:
         ...
         */
        static auto get_mask_and_expect(const char *const bitstring) {
         ...
         */
        template <size_t N>
        static auto get_arg_info(const char *const bitstring) {
            const auto one = static_cast<opcode_type>(1);
...
#pragma warning(disable : 4800) // forcing value to bool 'true' or 'false' (performance warning)
        ...
        template <typename Visitor, typename... Args, typename CallRetT>
        struct visitor_caller<CallRetT (Visitor::*)(Args...) const> {
            template <size_t... iota>
            static auto Make(std::integer_sequence<size_t, iota...>,
...
#pragma warning(pop)
    ...
    public:
         ...
         */
        template <typename FnT>
        static auto get_matcher(FnT fn, const char *const name, const char *const bitstring) {
